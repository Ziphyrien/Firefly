import { normalizeSessionRuntime } from "@/db/session-runtime-normalization";
import { linkToolResults } from "@/pi/agent/tool-result-linker";
import { StreamInterruptedRuntimeError } from "@/pi/agent/runtime-command-errors";
import { getCanonicalProvider, getDefaultProviderGroup } from "@/pi/models/catalog";
import {
  buildPreview,
  generateTitle,
  hasPersistableExchange,
} from "@/pi/sessions/session-metadata";
import { createEmptyUsage, type Usage } from "@/pi/types/models";
import type { AssistantMessage, ChatMessage } from "@/pi/types/chat";
